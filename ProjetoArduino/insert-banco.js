...
const cfg = {
    "host": "transporte-alimenticio.database.windows.net", // server name do banco de dados
    "user": "bandtec", // login ("bandtec")
    "pass": "Projeto01", // senha do banco de dados
    "db": "transporte-alimenticio" // nome da base de dados
};
